...
enum class shiftjes { 
  ...
  kJESUp,
  kJESDown,
  kJESSrcAbsoluteMPFBiasUp,
  kJESSrcAbsoluteMPFBiasDown,
  kJESSrcAbsoluteScaleUp,
  kJESSrcAbsoluteScaleDown,
  kJESSrcAbsoluteStatUp,
  kJESSrcAbsoluteStatDown,
  kJESSrcFlavorQCDUp,
  kJESSrcFlavorQCDDown,
  kJESSrcFragmentationUp,
  kJESSrcFragmentationDown,
  kJESSrcPileUpDataMCUp,
  kJESSrcPileUpDataMCDown,
  kJESSrcPileUpPtBBUp,
  kJESSrcPileUpPtBBDown,
  kJESSrcPileUpPtEC1Up,
  kJESSrcPileUpPtEC1Down,
  kJESSrcPileUpPtEC2Up,
  kJESSrcPileUpPtEC2Down,
  kJESSrcPileUpPtRefUp,
  kJESSrcPileUpPtRefDown,
  kJESSrcRelativeFSRUp,
  kJESSrcRelativeFSRDown,
  kJESSrcRelativeJEREC1Up,
  kJESSrcRelativeJEREC1Down,
  kJESSrcRelativePtBBUp,
  kJESSrcRelativePtBBDown,
  kJESSrcRelativePtEC1Up,
  kJESSrcRelativePtEC1Down,
  kJESSrcRelativePtEC2Up,
  kJESSrcRelativePtEC2Down,
  kJESSrcRelativeStatECUp,
  kJESSrcRelativeStatECDown,
  kJESSrcRelativeStatFSRUp,
  kJESSrcRelativeStatFSRDown,
  kJESSrcSinglePionECALUp,
  kJESSrcSinglePionECALDown,
  kJESSrcSinglePionHCALUp,
  kJESSrcSinglePionHCALDown,
  kJESSrcTimePtEtaUp,
  kJESSrcTimePtEtaDown,
  N
}; 
