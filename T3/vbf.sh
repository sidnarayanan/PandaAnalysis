...
export PANDA_CFG="http://t3serv001.mit.edu/~snarayan/histcatalog/vjets_nlo.cfg" 
...
export PANDA_FIT=/home/snarayan/home000/CMSSW_8_1_0/

export SUBMIT_TMPL="skim_vbf_tmpl.py"
export SUBMIT_NAME="v_004_16"
