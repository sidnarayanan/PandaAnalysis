//  The structure of this code needs to be re-worked. I'm sure the authors had
//  a good reason for doing things this way in the first place, but those reasons
//  don't apply here. I'm adding it is an external for now just so I can get a
//  result out, but this should not stand in the long run - SMN
//
...
#ifndef __PAHEPTOPTAGGER_WRAPPERV2_HH__
#define __PAHEPTOPTAGGER_WRAPPERV2_HH__
