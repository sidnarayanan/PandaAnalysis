...
vbf           = Process('VBF H(inv), BR=15%',root.kSignal2)
ggf           = Process('GGF H(inv), BR=15%',root.kSignal1)
...
vbf.add_file(baseDir+'vbfHinv_m125.root'); vbf.additional_weight = '0.15'
ggf.add_file(baseDir+'ggFHinv_m125.root'); ggf.additional_weight = '0.15'

processes = [ggf, vbf, qcd,diboson,top,wjets_ewk,zjets_ewk,wjets,zjets]
...
plot.add_distribution(FDistribution("fabs(jot12DPhi)",0,3,60,"#Delta #phi leading jets","Events",filename='jot12DPhi'))
